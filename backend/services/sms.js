...
class SMSService {
  constructor() {
    if (!process.env.AT_API_KEY) throw new Error('AT_API_KEY environment variable is required');
    if (!process.env.AT_USERNAME) throw new Error('AT_USERNAME environment variable is required');
