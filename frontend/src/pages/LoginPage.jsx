    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-green-600 rounded-2xl mb-4 shadow-lg shadow-green-900/20">
        ...
        <SignIn 
          ...
          appearance={{
            elements: {
              ...
              formFieldInput: "bg-slate-900/50 border-slate-700 text-white rounded-xl text-sm focus:ring-green-500",
              footerActionLink: "text-green-400 hover:text-green-300",
              primaryButton: "bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl",
