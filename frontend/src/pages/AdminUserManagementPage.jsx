        ...
        {tab === 'users' && (
          <>
            <UserTable
              ...
              onOpenLandlordModal={() => setLandlordModal({ open: true, full_name: '', email: '', phone: '', landlord_verification_doc_url: '' })}
              onDisableUser={handleDisable}
              onDeleteUser={(id) => handleSoftDelete(id)}
              onToggleAgentAreas={async (u) => {
              ...
              onEditRole={(u) => setSelectedRoleUser(u)}
              working={working}
            />
